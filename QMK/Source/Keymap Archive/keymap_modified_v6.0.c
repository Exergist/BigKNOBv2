...
// bigKNOBv2 hardware and original source code by LeafCutterLabs
...
/* // Tap Dance state retrieval method declaration
td_state_t cur_dance(qk_tap_dance_state_t *state);

// Tap Dance 'finish' method declaration
void encoder_finished(qk_tap_dance_state_t *state, void *user_data);

// Tap Dance 'reset' method declaration
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
	...
	(
		TD(ENCODER_DANCE), KC_F13, KC_F14, KC_F15, KC_F16 /// [Single-tap = Activate Next Layer, Press-Hold = Active Previous Layer, Press-Hold = Toggle RGB LEDs], F13, F14, F15, F16
	),
	[_SECONDARY] = LAYOUT // Layer 1
	(
		TD(ENCODER_DANCE), KC_F17, KC_F18, KC_F19, KC_F20 /// [Single-tap = Activate Next Layer, Press-Hold = Active Previous Layer, Press-Hold = Toggle RGB LEDs], F17, F18, F19, F20
	),
	[_TERTIARY] = LAYOUT // Layer 2
	(
		TD(ENCODER_DANCE), KC_F21, KC_F22, KC_F23, KC_F24 /// [Single-tap = Activate Next Layer, Press-Hold = Active Previous Layer, Press-Hold = Toggle RGB LEDs], F21, F22, F23, F24
	)
};
